...
% Defaults:
%   []  10    10     0    'mc'    10      0.05  'bo'    10      0.25   0.1    []
% 
% Inputs:
%
% Data matrix
...
%   Q2Ct=[1,1]
% Sample ID for repated-measures design
...
% Algorithm will try to start the Parellel Computing Toolbox to speed it up, it is recommended
